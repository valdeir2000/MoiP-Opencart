...
<script type="text/javascript">
	...
	var funcao_sucesso = function(data){
		...
		if (tipoPagamento == 'boleto' || tipoPagamento == 'debito') {
			mensagem_sucesso = '<i>Sua transação foi processada pelo <u>Moip Pagamentos S/A</u>.<br/>Caso tenha alguma dúvida referente a transação, entre em contato com o Moip.</i>';
		}else{
			mensagem_sucesso = '<i>Sua transação foi processada pelo <u>Moip Pagamentos S/A</u>. <br/>A sua transação está <b>"'+data.Status+'"</b> e o código Moip é <b>"'+data.CodigoMoIP+'"</b>.<br/>Caso tenha alguma dúvida referente a transação, entre em contato com o Moip.</i>';
		}
