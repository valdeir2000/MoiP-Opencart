...
$languageMail = new Language(DIR_LANGUAGE);
...
$autorizado    = $status_moip->rows[6]['value'];
$iniciado      = $status_moip->rows[7]['value'];
$boletImpresso = $status_moip->rows[8]['value'];
$concluido     = $status_moip->rows[9]['value'];
$cancelado     = $status_moip->rows[10]['value'];
$emAnalise     = $status_moip->rows[11]['value'];
$estornado     = $status_moip->rows[12]['value'];
$emRevisao     = $status_moip->rows[13]['value'];
$reembolsado   = $status_moip->rows[14]['value'];
